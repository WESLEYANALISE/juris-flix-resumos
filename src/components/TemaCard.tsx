...
const TemaCard: React.FC<TemaCardProps> = ({ tema, assuntosCount, onClick }) => {
  return (
    <button
      onClick={onClick}
      className="w-full p-5 bg-netflix-darkGray border border-netflix-gray rounded-lg hover:border-netflix-red hover:bg-netflix-gray transition-all duration-300 text-left group"
    >
